class MainLevel extends LevelInterface {
    setup(){
        ...
        this.planets = [
            {orbitSize:0, size:125, color: 'yellow', angle:0, speed:0, drawOrder:0},
            {orbitSize:250, size:10, color: 'red', angle:0, speed:40, drawOrder:0},
            {orbitSize:350, size:25, color: 'green', angle:90, speed:20, drawOrder:0},
            {orbitSize:400, size:35, color: 'blue', angle:200, speed:10, drawOrder:0}
        ]
    }
    ...
    drawPlanet(delta, planet){
        ...
        // draw the planet at it's center
        // drawImage(planet.image,projectPoint.x-planetRadius, projectPoint.y-planetRadius,planetRadius*2, planetRadius*2)        
        drawCircle(projectPoint.x, projectPoint.y, planetRadius, planet.color);
    }
